...
contract BunyERC6551Registry is IERC6551Registry {
    ...
    // Mapping from account address to account information
    ...
    function createAccount(
        ...
        // Store account information in the mapping
        accounts[_account] = IBunyAccount(implementation, chainId, tokenContract, tokenId, salt);
